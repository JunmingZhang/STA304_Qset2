...
<!-- # Name(s) of Author(s)  -->
<!-- # Date -->
#### Code and data supporting this analysis is available at: <Github website!!!>
## Abstract
...
$(p/1-p)$ = exp(${\beta}_0$ + ${\beta}_1$marital_statusLiving_common_law + ${\beta}_2$marital_status_Married + ... + ${\beta}_{23}$self_rated_health_Excellent + ... + ${\beta}_{32}$self_rated_mental_health_Very_Good)
